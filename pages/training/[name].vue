...
try {
  ...
  useSeoMeta({
    ...
    ogImage: courseData.value.data.productImageUrl ? `${apiBase}/${courseData.value.data.productImageUrl}` : "https://adminpanel.orbit-eng.net/logohero.png",
    ...
    twitterImage: courseData.value.data.productImageUrl ? `${apiBase}/${courseData.value.data.productImageUrl}` : "https://adminpanel.orbit-eng.net/logohero.png",
