import { _ as __nuxt_component_0$1, l as localePath, u as useName, r as rtl, c as cImg, a as useDes, b as useDes1, d as useDes2, e as useDes3 } from './useMethods-Bj3Kkejg.mjs';
import __nuxt_component_2$1 from './Icon-CBg3hLjd.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-details-root" }, _attrs))} data-v-e498c5ba><div class="container" data-v-e498c5ba><div class="row path-links text-start pt-4" data-v-e498c5ba><h5 class="links-frame" dir="auto" data-v-e498c5ba>`);
      ...
      _push(` / <span class="path-link" data-v-e498c5ba>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(__props.item))}</span></h5></div><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "mb-10 px-0"])}" dir="auto" data-v-e498c5ba><h1 class="metal-text" data-v-e498c5ba><span data-v-e498c5ba>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(__props.item))}</span></h1></div></div>`);
      if (__props.item) {
        _push(`<div class="container" dir="auto" data-v-e498c5ba><div class="row description" data-v-e498c5ba>`);
        if (__props.item.descriptionEn) {
          _push(`<div class="section" data-v-e498c5ba>`);
          if (__props.item.image) {
            _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-e498c5ba><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(__props.item.image))} alt=" Photo" data-v-e498c5ba></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div data-v-e498c5ba>${(_a2 = ("useDes" in _ctx ? _ctx.useDes : unref(useDes))(__props.item)) != null ? _a2 : ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.item.descriptionEn1) {
          ...
          if (__props.item.image1) {
            _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-e498c5ba><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(__props.item.image1))} alt=" Photo" data-v-e498c5ba></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div data-v-e498c5ba>${(_b2 = ("useDes1" in _ctx ? _ctx.useDes1 : unref(useDes1))(__props.item)) != null ? _b2 : ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.item.descriptionEn2) {
          ...
          if ((_a = __props.item) == null ? void 0 : _a.image2) {
            _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-e498c5ba><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(__props.item.image2))} alt=" Photo" data-v-e498c5ba></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div data-v-e498c5ba>${(_c2 = ("useDes2" in _ctx ? _ctx.useDes2 : unref(useDes2))(__props.item)) != null ? _c2 : ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.item.descriptionEn3) {
          ...
          if ((_b = __props.item) == null ? void 0 : _b.image3) {
            _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-e498c5ba><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(__props.item.image3))} alt=" Photo" data-v-e498c5ba></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div data-v-e498c5ba>${(_d2 = ("useDes3" in _ctx ? _ctx.useDes3 : unref(useDes3))(__props.item)) != null ? _d2 : ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        if (((_c = __props.item.pageAttachements) == null ? void 0 : _c.length) > 0) {
          _push(`<div class="row attachments-section pt-1" data-v-e498c5ba><h2 class="section-title" data-v-e498c5ba>${ssrInterpolate(_ctx.$t("Attachments"))}</h2><ol class="page-attachments px-0 ps-10" data-v-e498c5ba><!--[-->`);
          ssrRenderList((_d = __props.item) == null ? void 0 : _d.pageAttachements, (attachment) => {
            _push(`<li data-v-e498c5ba><a${ssrRenderAttr("href", `${unref(apiBase)}/${attachment.file}`)} target="_blank" class="attachment-link" data-v-e498c5ba>`);
        ...
        if (((_e = __props.item.pagePhotos) == null ? void 0 : _e.length) > 0) {
          _push(`<div class="row page-photos" data-v-e498c5ba><h2 class="section-title" data-v-e498c5ba>${ssrInterpolate(_ctx.$t("photos"))}</h2><div class="row" data-v-e498c5ba><!--[-->`);
          ssrRenderList((_f = __props.item) == null ? void 0 : _f.pagePhotos, (photo) => {
            _push(`<div class="col-md-3 mb-5" data-v-e498c5ba><div class="card photo-card contain" data-v-e498c5ba><img${ssrRenderAttr("src", `${unref(apiBase)}/${photo.image}`)} class="card-img-top img-fluid" alt="Page Photo" data-v-e498c5ba><img${ssrRenderAttr("src", `${unref(apiBase)}/${photo.image}`)} class="card-img-top img-fluid bg" alt="Page Photo" data-v-e498c5ba></div></div>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
        ...
        if (((_g = __props.item.pageVideos) == null ? void 0 : _g.length) > 0) {
          _push(`<div class="row video-section pt-5" data-v-e498c5ba><h2 class="section-title" data-v-e498c5ba>${ssrInterpolate(_ctx.$t("Videos"))}</h2><div class="video-list" data-v-e498c5ba><!--[-->`);
          ssrRenderList(__props.item.pageVideos, (video) => {
            _push(`<div class="video-item" data-v-e498c5ba><video controls${ssrRenderAttr("src", `${unref(apiBase)}/${video.file}`)} class="video-player" data-v-e498c5ba> Your browser does not support the video tag. </video></div>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e498c5ba"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=PageDetails-BHqbriu8.mjs.map
