...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-details-root" }, _attrs))} data-v-8455d029><div class="container" data-v-8455d029><div class="row path-links text-start pt-4" data-v-8455d029><h5 class="links-frame" dir="auto" data-v-8455d029>`);
      ...
      _push(` / <span class="path-link" data-v-8455d029>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(__props.item))}</span></h5></div><div class="${ssrRenderClass([("isEn" in _ctx ? _ctx.isEn : unref(isEn))() ? "title_en" : "", "title-formatting3 mb-10 px-0"])}" data-v-8455d029><h1 style="${ssrRenderStyle({ "font-weight": "var(--fw-9)" })}" class="text-center color" data-v-8455d029><span data-v-8455d029>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(__props.item))}</span></h1></div></div>`);
      if (__props.item) {
        _push(`<div class="container" dir="auto" data-v-8455d029><div class="row description" data-v-8455d029>`);
        if (__props.item.descriptionEn) {
          _push(`<div class="section" data-v-8455d029>`);
          if (__props.item.image) {
            _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-8455d029><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(__props.item.image))} alt=" Photo" data-v-8455d029></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div data-v-8455d029>${(_a2 = ("useDes" in _ctx ? _ctx.useDes : unref(useDes))(__props.item)) != null ? _a2 : ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.item.descriptionEn1) {
          ...
          if (__props.item.image1) {
            _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-8455d029><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(__props.item.image1))} alt=" Photo" data-v-8455d029></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div data-v-8455d029>${(_b2 = ("useDes1" in _ctx ? _ctx.useDes1 : unref(useDes1))(__props.item)) != null ? _b2 : ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.item.descriptionEn2) {
          ...
          if ((_a = __props.item) == null ? void 0 : _a.image2) {
            _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-8455d029><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(__props.item.image2))} alt=" Photo" data-v-8455d029></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div data-v-8455d029>${(_c2 = ("useDes2" in _ctx ? _ctx.useDes2 : unref(useDes2))(__props.item)) != null ? _c2 : ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.item.descriptionEn3) {
          ...
          if ((_b = __props.item) == null ? void 0 : _b.image3) {
            _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-8455d029><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(__props.item.image3))} alt=" Photo" data-v-8455d029></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div data-v-8455d029>${(_d2 = ("useDes3" in _ctx ? _ctx.useDes3 : unref(useDes3))(__props.item)) != null ? _d2 : ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        if (((_c = __props.item.pageAttachements) == null ? void 0 : _c.length) > 0) {
          _push(`<div class="row attachments-section pt-1" data-v-8455d029><h2 class="section-title" data-v-8455d029>${ssrInterpolate(_ctx.$t("Attachments"))}</h2><ol class="page-attachments px-0 ps-10" data-v-8455d029><!--[-->`);
          ssrRenderList((_d = __props.item) == null ? void 0 : _d.pageAttachements, (attachment) => {
            _push(`<li data-v-8455d029><a${ssrRenderAttr("href", `${unref(apiBase)}/${attachment.file}`)} target="_blank" class="attachment-link" data-v-8455d029>`);
        ...
        if (((_e = __props.item.pagePhotos) == null ? void 0 : _e.length) > 0) {
          _push(`<div class="row page-photos" data-v-8455d029><h2 class="section-title" data-v-8455d029>${ssrInterpolate(_ctx.$t("photos"))}</h2><div class="row" data-v-8455d029><!--[-->`);
          ssrRenderList((_f = __props.item) == null ? void 0 : _f.pagePhotos, (photo) => {
            _push(`<div class="col-md-3 mb-5" data-v-8455d029><div class="card photo-card contain" data-v-8455d029><img${ssrRenderAttr("src", `${unref(apiBase)}/${photo.image}`)} class="card-img-top img-fluid" alt="Page Photo" data-v-8455d029><img${ssrRenderAttr("src", `${unref(apiBase)}/${photo.image}`)} class="card-img-top img-fluid bg" alt="Page Photo" data-v-8455d029></div></div>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
        ...
        if (((_g = __props.item.pageVideos) == null ? void 0 : _g.length) > 0) {
          _push(`<div class="row video-section pt-5" data-v-8455d029><h2 class="section-title" data-v-8455d029>${ssrInterpolate(_ctx.$t("Videos"))}</h2><div class="video-list" data-v-8455d029><!--[-->`);
          ssrRenderList(__props.item.pageVideos, (video) => {
            _push(`<div class="video-item" data-v-8455d029><video controls${ssrRenderAttr("src", `${unref(apiBase)}/${video.file}`)} class="video-player" data-v-8455d029> Your browser does not support the video tag. </video></div>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8455d029"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=PageDetails-BoK8aLrR.mjs.map
