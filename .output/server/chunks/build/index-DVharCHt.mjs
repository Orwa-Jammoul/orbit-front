...
import { r as rtl, u as useName, g as getInnerText, a as useDes, i as isAr, b as useDes1 } from './useMethods-36IGheXp.mjs';
...
import { _ as _sfc_main$6 } from './Services-DfLvlxCb.mjs';
import { _ as _sfc_main$7 } from './training-C2auwM_t.mjs';
import 'vue-router';
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "main-slide" }, _attrs))} data-v-a28e3bcd><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" dir="auto" data-v-a28e3bcd><img${ssrRenderAttr("src", `${unref(apiBase)}/${__props.data.image}`)} loading="lazy"${ssrRenderAttr("alt", `slide-img`)} data-v-a28e3bcd></div><div class="rect" data-v-a28e3bcd></div><div class="content" data-v-a28e3bcd><div class="slider-title metal-text" data-v-a28e3bcd>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(__props.data))}</div><div class="slider-des" data-v-a28e3bcd>${(_a = ("useDes" in _ctx ? _ctx.useDes : unref(useDes))(__props.data)) != null ? _a : ""}</div>`);
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-a28e3bcd"]]);
const _sfc_main$4 = {
  __name: "MainHeader",
  __ssrInlineRender: true,
  async setup(__props) {
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "slider-root" }, _attrs))} data-v-bfe26398>`);
            ...
            if (_push2) {
              ...
              ssrRenderList(techs, (tech, index) => {
                _push2(ssrRenderComponent(unref(SplideSlide), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="tech-card pcc" data-v-bfe26398${_scopeId2}><h1 class="card-title" data-v-bfe26398${_scopeId2}>${ssrInterpolate(tech.nameEn)}</h1></div>`);
                    } else {
                      return [
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-bfe26398"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-page" }, _attrs))} data-v-adca6347>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-adca6347"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=index-DVharCHt.mjs.map
