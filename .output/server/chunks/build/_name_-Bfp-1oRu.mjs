...
import { _ as __nuxt_component_2 } from './training-qCNWIfUk.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-root" }, _attrs))} data-v-3687ed10><div class="container" data-v-3687ed10><div class="path-links text-start pt-4" data-v-3687ed10><h5 class="links-frame" dir="auto" data-v-3687ed10>`);
      ...
      _push(` / <span class="path-link" data-v-3687ed10>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(dataResult)))}</span></h5></div></div><div class="page-body container"${ssrRenderAttr("dir", ("rtl" in _ctx ? _ctx.rtl : unref(rtl))())} data-v-3687ed10><div class="main-content" data-v-3687ed10><div class="content-body" data-v-3687ed10><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "mb-10 px-0"])}" dir="auto" data-v-3687ed10><h1 class="metal-text" data-v-3687ed10><span data-v-3687ed10>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(dataResult)))}</span></h1></div><div class="description" data-v-3687ed10><div class="section" data-v-3687ed10>`);
      if ((_a = unref(dataResult)) == null ? void 0 : _a.productImageUrl) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-3687ed10><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).productImageUrl))} alt=" Photo" data-v-3687ed10></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-3687ed10>${(_a2 = ("useDes" in _ctx ? _ctx.useDes : unref(useDes))(unref(dataResult))) != null ? _a2 : ""}</div></div><div class="section" data-v-3687ed10>`);
      if ((_b = unref(dataResult)) == null ? void 0 : _b.productImageUrl1) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-3687ed10><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).productImageUrl1))} alt=" Photo" data-v-3687ed10></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-3687ed10>${(_b2 = ("useDes1" in _ctx ? _ctx.useDes1 : unref(useDes1))(unref(dataResult))) != null ? _b2 : ""}</div></div><div class="section" data-v-3687ed10>`);
      if ((_c = unref(dataResult)) == null ? void 0 : _c.productImageUrl2) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-3687ed10><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).productImageUrl2))} alt=" Photo" data-v-3687ed10></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-3687ed10>${(_c2 = ("useDes2" in _ctx ? _ctx.useDes2 : unref(useDes2))(unref(dataResult))) != null ? _c2 : ""}</div></div><div class="section" data-v-3687ed10>`);
      if ((_d = unref(dataResult)) == null ? void 0 : _d.productImageUrl3) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-3687ed10><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).productImageUrl3))} alt=" Photo" data-v-3687ed10></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-3687ed10>${(_d2 = ("useDes3" in _ctx ? _ctx.useDes3 : unref(useDes3))(unref(dataResult))) != null ? _d2 : ""}</div></div></div></div><aside class="side-nav" data-v-3687ed10><p class="px-0 ps-2" data-v-3687ed10>${ssrInterpolate(_ctx.$t("more"))}</p><!--[-->`);
      ssrRenderList(unref(similarItems), (similar, index) => {
        _push(`<div class="mb-3" data-v-3687ed10>`);
        _push(ssrRenderComponent(_component_CardServiceH, { cardData: similar }, null, _parent));
        _push(`</div>`);
      });
      _push(`<!--]--></aside></div></div><div class="container" data-v-3687ed10>`);
...
const _name_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3687ed10"]]);

export { _name_ as default };
//# sourceMappingURL=_name_-Bfp-1oRu.mjs.map
