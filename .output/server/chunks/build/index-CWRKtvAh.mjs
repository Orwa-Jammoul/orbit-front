...
import { u as useName, g as getInnerText, a as useDes, _ as __nuxt_component_0$2, l as localePath, i as isAr, r as rtl } from './useMethods-CeTnUbTS.mjs';
import __nuxt_component_1$1 from './Icon-BQJZeqX5.mjs';
import { p as publicAssetsURL } from '../_/nitro.mjs';
import { _ as __nuxt_component_0$3 } from './service-CGlw78UM.mjs';
import 'unhead';
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "design-root" }, _attrs))} data-v-c610f1a4><div class="bg-section" data-v-c610f1a4>`);
      if (!unref(videosLoaded)) {
        _push(`<div class="loading-placeholder" data-v-c610f1a4></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ssrRenderList(videoSources, (video, index) => {
        _push(`<video class="bg-video" style="${ssrRenderStyle({ display: unref(currentVideoIndex) === index ? "block" : "none" })}" muted playsinline preload="auto" data-v-c610f1a4><source${ssrRenderAttr("src", video.src)}${ssrRenderAttr("type", video.type)} data-v-c610f1a4> Your browser does not support the video tag. </video>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-c610f1a4"]]);
const _sfc_main$6 = {
  __name: "MainHeader",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "header-main" }, _attrs))} data-v-68b86991>`);
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-68b86991"]]);
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({
        ...
        dir: "auto"
      }, _attrs))} data-v-fe684279><div class="img-frame contain" data-v-fe684279><img${ssrRenderAttr("src", _imports_0)} alt="image" data-v-fe684279></div><div class="about-frame" data-v-fe684279><div class="about-box1 grid-bg1" data-v-fe684279><h1 class="metal-text" data-v-fe684279>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(about)))}</h1><p data-v-fe684279>${ssrInterpolate(("getInnerText" in _ctx ? _ctx.getInnerText : unref(getInnerText))(("useDes" in _ctx ? _ctx.useDes : unref(useDes))(unref(about))))}</p><div class="go-to pcs" data-v-fe684279><p class="m-0" data-v-fe684279>${ssrInterpolate(_ctx.$t("read-more"))}</p>`);
      ...
      _push(`</div><div class="gr-circle1" data-v-fe684279></div><div class="gr-circle3" data-v-fe684279></div></div><div class="about-box2 grid-bg1" data-v-fe684279><h1 class="metal-text" data-v-fe684279>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(about)))}</h1><p data-v-fe684279>${ssrInterpolate(("getInnerText" in _ctx ? _ctx.getInnerText : unref(getInnerText))(("useDes" in _ctx ? _ctx.useDes : unref(useDes))(unref(about))))}</p><div class="go-to pcs" data-v-fe684279><p class="m-0" data-v-fe684279>${ssrInterpolate(_ctx.$t("read-more"))}</p>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        class: "icon-frame pcc mx-0 ms-2",
        to: ("localePath" in _ctx ? _ctx.localePath : unref(localePath))("/about-us")
      }, {
      ...
      _push(`</div><div class="gr-circle1" data-v-fe684279></div><div class="gr-circle3" data-v-fe684279></div></div></div><div class="gr-circle1" data-v-fe684279></div><div class="gr-circle2" data-v-fe684279></div></section>`);
    };
  }
};
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-fe684279"]]);
const _sfc_main$4 = {
  __name: "Services",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Swiper = Swiper;
      const _component_SwiperSlide = SwiperSlide;
      const _component_CardService = __nuxt_component_0$3;
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "section-root",
        dir: "auto"
      }, _attrs))} data-v-1cd1a14d><div class="container" data-v-1cd1a14d><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "row section-title"])}" data-v-1cd1a14d><h2 class="metal-text" data-v-1cd1a14d>${ssrInterpolate(_ctx.$t("services"))}</h2><p data-v-1cd1a14d> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt cum molestias aspernatur labore inventore hic? Recusandae praesentium ex delectus odio? </p></div>`);
      if (!unref(isLoading)) {
        _push(`<div class="services-section row px-3" data-v-1cd1a14d>`);
        _push(ssrRenderComponent(_component_Swiper, {
          class: "mySwiper",
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-1cd1a14d"]]);
const _sfc_main$3 = {};
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "section-root",
        dir: "auto"
      }, _attrs))} data-v-ae00853e><div class="container" data-v-ae00853e><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "row section-title"])}" data-v-ae00853e><h2 class="metal-text" data-v-ae00853e>${ssrInterpolate(_ctx.$t("training"))}</h2><p data-v-ae00853e> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt cum molestias aspernatur labore inventore hic? Recusandae praesentium ex delectus odio? </p></div>`);
      if (!unref(isLoading)) {
        _push(`<div class="training-section row" data-v-ae00853e>`);
        _push(ssrRenderComponent(_component_Swiper, {
          class: "mySwiper",
          dir: ("rtl" in _ctx ? _ctx.rtl : unref(rtl))(),
          modules: ["SwiperAutoplay" in _ctx ? _ctx.SwiperAutoplay : unref(Autoplay), "SwiperPagination" in _ctx ? _ctx.SwiperPagination : unref(Pagination), "SwiperNavigation" in _ctx ? _ctx.SwiperNavigation : unref(Navigation)],
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ae00853e"]]);
const _sfc_main$1 = {};
...
//# sourceMappingURL=index-CWRKtvAh.mjs.map
