import { _ as _export_sfc, a as useLocalePath, u as useRuntimeConfig, h as useRoute$1, g as useI18n, o as useRouter$1, d as useGetSiteApi, f as useHead, b as __nuxt_component_0 } from './server.mjs';
import { u as useName, r as rtl, c as cImg, h as useAlt, a as useDes, b as useDes1, e as useDes2, f as useDes3, d as useEndpoint, j as useTr } from './useMethods-DGpMLSZI.mjs';
...
import { _ as _sfc_main$2 } from './Services-C0rbhR-E.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-root" }, _attrs))} data-v-069d3c51><div class="container" data-v-069d3c51><div class="path-links text-start pt-4" data-v-069d3c51><h5 class="links-frame" dir="auto" data-v-069d3c51>`);
      ...
      _push(` / <span class="path-link" data-v-069d3c51>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(dataResult)))}</span></h5></div></div><div class="page-body container"${ssrRenderAttr("dir", ("rtl" in _ctx ? _ctx.rtl : unref(rtl))())} data-v-069d3c51><div class="main-content" data-v-069d3c51><div class="content-body" data-v-069d3c51><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "mb-10 px-0"])}" dir="auto" data-v-069d3c51><h1 class="metal-text" data-v-069d3c51><span data-v-069d3c51>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(dataResult)))}</span></h1></div><div class="description" data-v-069d3c51><div class="section" data-v-069d3c51>`);
      if ((_a2 = unref(dataResult)) == null ? void 0 : _a2.courseImageUrl1) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-069d3c51><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).courseImageUrl1))}${ssrRenderAttr("alt", ("useAlt" in _ctx ? _ctx.useAlt : unref(useAlt))(unref(dataResult).productSeos, 1))} data-v-069d3c51></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-069d3c51>${(_a3 = ("useDes" in _ctx ? _ctx.useDes : unref(useDes))(unref(dataResult))) != null ? _a3 : ""}</div></div><div class="section" data-v-069d3c51>`);
      if ((_b2 = unref(dataResult)) == null ? void 0 : _b2.courseImageUrl2) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-069d3c51><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).courseImageUrl2))}${ssrRenderAttr("alt", ("useAlt" in _ctx ? _ctx.useAlt : unref(useAlt))(unref(dataResult).productSeos, 2))} data-v-069d3c51></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-069d3c51>${(_b3 = ("useDes1" in _ctx ? _ctx.useDes1 : unref(useDes1))(unref(dataResult))) != null ? _b3 : ""}</div></div><div class="section" data-v-069d3c51>`);
      if ((_c2 = unref(dataResult)) == null ? void 0 : _c2.courseImageUrl3) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-069d3c51><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).courseImageUrl3))}${ssrRenderAttr("alt", ("useAlt" in _ctx ? _ctx.useAlt : unref(useAlt))(unref(dataResult).productSeos, 3))} data-v-069d3c51></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-069d3c51>${(_c3 = ("useDes2" in _ctx ? _ctx.useDes2 : unref(useDes2))(unref(dataResult))) != null ? _c3 : ""}</div></div><div class="section" data-v-069d3c51>`);
      if ((_d = unref(dataResult)) == null ? void 0 : _d.courseImageUrl4) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-069d3c51><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).courseImageUrl4))}${ssrRenderAttr("alt", ("useAlt" in _ctx ? _ctx.useAlt : unref(useAlt))(unref(dataResult).courseSeos, 4))} data-v-069d3c51></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-069d3c51>${(_d2 = ("useDes3" in _ctx ? _ctx.useDes3 : unref(useDes3))(unref(dataResult))) != null ? _d2 : ""}</div></div></div></div><aside class="side-nav" data-v-069d3c51><p class="px-0 ps-2" data-v-069d3c51>${ssrInterpolate(_ctx.$t("more"))}</p><!--[-->`);
      ssrRenderList(unref(similarItems), (similar, index) => {
        _push(`<div class="mb-3" data-v-069d3c51>`);
        _push(ssrRenderComponent(_component_CardCourseH, { cardData: similar }, null, _parent));
        _push(`</div>`);
      });
      _push(`<!--]--></aside></div></div><div class="container pt-5" data-v-069d3c51>`);
...
const _name_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-069d3c51"]]);

export { _name_ as default };
//# sourceMappingURL=_name_-ss8WYQlg.mjs.map
