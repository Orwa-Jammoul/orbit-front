...
import { f as useLang, b as useRouter$1, c as useNuxtApp, p as parseQuery, u as useRuntimeConfig, h as hasProtocol, r as resolveRouteObject, j as joinURL, n as navigateTo, w as withTrailingSlash, d as withoutTrailingSlash, e as nuxtLinkDefaults } from './server.mjs';
...
const useDes1 = (data) => {
  ...
  const lang = useLang().value ? useLang().value : "en";
  if (lang === "en") {
    return (_a = data.englishDescription1) != null ? _a : vNotFound;
  } else if (lang === "de") {
    return (_b = data.descriptionGe1) != null ? _b : vNotFound;
  } else {
    return (_d = (_c = data.description1) != null ? _c : data.arabicDescription1) != null ? _d : vNotFound;
  }
};
const useDes2 = (data) => {
  var _a, _b, _c, _d;
  ...
  const lang = useLang().value ? useLang().value : "en";
  if (lang === "en") {
    return (_a = data.englishDescription2) != null ? _a : vNotFound;
  } else if (lang === "de") {
    return (_b = data.descriptionGe2) != null ? _b : vNotFound;
  } else {
    return (_d = (_c = data.description2) != null ? _c : data.arabicDescription2) != null ? _d : vNotFound;
  }
};
const useDes3 = (data) => {
  var _a, _b, _c, _d;
  ...
  const lang = useLang().value ? useLang().value : "en";
  if (lang === "en") {
    return (_a = data.englishDescription3) != null ? _a : vNotFound;
  } else if (lang === "de") {
    return (_b = data.descriptionGe3) != null ? _b : vNotFound;
  } else {
    return (_d = (_c = data.description3) != null ? _c : data.arabicDescription3) != null ? _d : vNotFound;
  }
};
...
export { __nuxt_component_0 as _, useDes as a, isEn as b, cImg as c, useDes1 as d, useDes2 as e, useDes3 as f, getInnerText as g, isAr as i, localePath as l, rtl as r, useName as u };
//# sourceMappingURL=useMethods-CeTnUbTS.mjs.map
