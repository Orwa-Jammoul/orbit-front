...
import { _ as __nuxt_component_2 } from './training-5mJE4-SM.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_nuxt_link, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="gr-circle1" data-v-77608017${_scopeId}></div><div class="service-card-frame" data-v-77608017${_scopeId}><div class="card-left" data-v-77608017${_scopeId}><div class="img-frame cover" data-v-77608017${_scopeId}><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(__props.cardData.productImageUrl1))}${ssrRenderAttr("alt", ("useName" in _ctx ? _ctx.useName : unref(useName))(__props.cardData))} data-v-77608017${_scopeId}></div></div><div class="card-right" data-v-77608017${_scopeId}><h5 class="card-title" data-v-77608017${_scopeId}>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(__props.cardData))}</h5><p class="card-des" data-v-77608017${_scopeId}>${ssrInterpolate(("getInnerText" in _ctx ? _ctx.getInnerText : unref(getInnerText))(("useDes1" in _ctx ? _ctx.useDes1 : unref(useDes1))(__props.cardData)))}</p><div class="buttons" data-v-77608017${_scopeId}><button class="details-btn" data-v-77608017${_scopeId}>${ssrInterpolate(_ctx.$t("details"))}</button></div></div></div>`);
          } else {
            return [
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-77608017"]]);
const _sfc_main = {
  __name: "[name]",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-root" }, _attrs))} data-v-3d92289c><div class="container" data-v-3d92289c><div class="path-links text-start pt-4" data-v-3d92289c><h5 class="links-frame" dir="auto" data-v-3d92289c>`);
      ...
      _push(` / <span class="path-link" data-v-3d92289c>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(dataResult)))}</span></h5></div></div><div class="page-body container"${ssrRenderAttr("dir", ("rtl" in _ctx ? _ctx.rtl : unref(rtl))())} data-v-3d92289c><div class="main-content" data-v-3d92289c><div class="content-body" data-v-3d92289c><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "mb-10 px-0"])}" dir="auto" data-v-3d92289c><h1 class="metal-text" data-v-3d92289c><span data-v-3d92289c>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(dataResult)))}</span></h1></div><div class="description" data-v-3d92289c><div class="section" data-v-3d92289c>`);
      if ((_a = unref(dataResult)) == null ? void 0 : _a.productImageUrl) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-3d92289c><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).productImageUrl))} alt=" Photo" data-v-3d92289c></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-3d92289c>${(_a2 = ("useDes" in _ctx ? _ctx.useDes : unref(useDes))(unref(dataResult))) != null ? _a2 : ""}</div></div><div class="section" data-v-3d92289c>`);
      if ((_b = unref(dataResult)) == null ? void 0 : _b.productImageUrl1) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-3d92289c><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).productImageUrl1))} alt=" Photo" data-v-3d92289c></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-3d92289c>${(_b2 = ("useDes1" in _ctx ? _ctx.useDes1 : unref(useDes1))(unref(dataResult))) != null ? _b2 : ""}</div></div><div class="section" data-v-3d92289c>`);
      if ((_c = unref(dataResult)) == null ? void 0 : _c.productImageUrl2) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-3d92289c><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).productImageUrl2))} alt=" Photo" data-v-3d92289c></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-3d92289c>${(_c2 = ("useDes2" in _ctx ? _ctx.useDes2 : unref(useDes2))(unref(dataResult))) != null ? _c2 : ""}</div></div><div class="section" data-v-3d92289c>`);
      if ((_d = unref(dataResult)) == null ? void 0 : _d.productImageUrl3) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-3d92289c><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).productImageUrl3))} alt=" Photo" data-v-3d92289c></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-3d92289c>${(_d2 = ("useDes3" in _ctx ? _ctx.useDes3 : unref(useDes3))(unref(dataResult))) != null ? _d2 : ""}</div></div></div></div><aside class="side-nav" data-v-3d92289c><p class="px-0 ps-2" data-v-3d92289c>${ssrInterpolate(_ctx.$t("more"))}</p><!--[-->`);
      ssrRenderList(unref(similarItems), (similar, index) => {
        _push(`<div class="mb-3" data-v-3d92289c>`);
        _push(ssrRenderComponent(_component_CardServiceH, { cardData: similar }, null, _parent));
        _push(`</div>`);
      });
      _push(`<!--]--></aside></div></div><div class="container" data-v-3d92289c>`);
...
const _name_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3d92289c"]]);

export { _name_ as default };
//# sourceMappingURL=_name_-2kFqp4ru.mjs.map
