...
import { u as useName, r as rtl, c as cImg, f as useAlt, a as useDes, b as useDes1, d as useDes2, e as useDes3, h as useEndpoint } from './useMethods-Cg0KMTOU.mjs';
...
import { _ as _export_sfc, a as useLocalePath, u as useRuntimeConfig, e as useI18n, f as useRoute$1, h as useRouter$1, b as useGetSiteApi, d as useHead } from './server.mjs';
import { _ as _sfc_main$2 } from './training-D8_7RnLx.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-root" }, _attrs))} data-v-0d4130c4><div class="container" data-v-0d4130c4><div class="path-links text-start pt-4" data-v-0d4130c4><h5 class="links-frame" dir="auto" data-v-0d4130c4>`);
      ...
      _push(` / <span class="path-link" data-v-0d4130c4>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(dataResult)))}</span></h5></div></div><div class="page-body container"${ssrRenderAttr("dir", ("rtl" in _ctx ? _ctx.rtl : unref(rtl))())} data-v-0d4130c4><div class="main-content" data-v-0d4130c4><div class="content-body" data-v-0d4130c4><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "mb-10 px-0"])}" dir="auto" data-v-0d4130c4><h1 class="metal-text" data-v-0d4130c4><span data-v-0d4130c4>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(dataResult)))}</span></h1></div><div class="description" data-v-0d4130c4><div class="section" data-v-0d4130c4>`);
      if ((_a2 = unref(dataResult)) == null ? void 0 : _a2.productImageUrl) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-0d4130c4><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).productImageUrl))}${ssrRenderAttr("alt", ("useAlt" in _ctx ? _ctx.useAlt : unref(useAlt))(unref(dataResult).productSeos, 1))} data-v-0d4130c4></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-0d4130c4>${(_a3 = ("useDes" in _ctx ? _ctx.useDes : unref(useDes))(unref(dataResult))) != null ? _a3 : ""}</div></div><div class="section" data-v-0d4130c4>`);
      if ((_b2 = unref(dataResult)) == null ? void 0 : _b2.productImageUrl1) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-0d4130c4><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).productImageUrl1))}${ssrRenderAttr("alt", ("useAlt" in _ctx ? _ctx.useAlt : unref(useAlt))(unref(dataResult).productSeos, 1))} data-v-0d4130c4></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-0d4130c4>${(_b3 = ("useDes1" in _ctx ? _ctx.useDes1 : unref(useDes1))(unref(dataResult))) != null ? _b3 : ""}</div></div><div class="section" data-v-0d4130c4>`);
      if ((_c2 = unref(dataResult)) == null ? void 0 : _c2.productImageUrl2) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-0d4130c4><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).productImageUrl2))}${ssrRenderAttr("alt", ("useAlt" in _ctx ? _ctx.useAlt : unref(useAlt))(unref(dataResult).productSeos, 2))} data-v-0d4130c4></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-0d4130c4>${(_c3 = ("useDes2" in _ctx ? _ctx.useDes2 : unref(useDes2))(unref(dataResult))) != null ? _c3 : ""}</div></div><div class="section" data-v-0d4130c4>`);
      if ((_d = unref(dataResult)) == null ? void 0 : _d.productImageUrl3) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-0d4130c4><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).productImageUrl3))}${ssrRenderAttr("alt", ("useAlt" in _ctx ? _ctx.useAlt : unref(useAlt))(unref(dataResult).productSeos, 3))} data-v-0d4130c4></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-0d4130c4>${(_d2 = ("useDes3" in _ctx ? _ctx.useDes3 : unref(useDes3))(unref(dataResult))) != null ? _d2 : ""}</div></div></div></div><aside class="side-nav" data-v-0d4130c4><p class="px-0 ps-2" data-v-0d4130c4>${ssrInterpolate(_ctx.$t("more"))}</p><!--[-->`);
      ssrRenderList(unref(similarItems), (similar, index) => {
        _push(`<div class="mb-3" data-v-0d4130c4>`);
        _push(ssrRenderComponent(_component_CardServiceH, { cardData: similar }, null, _parent));
        _push(`</div>`);
      });
      _push(`<!--]--></aside></div></div><div class="container" data-v-0d4130c4>`);
...
const _name_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0d4130c4"]]);

export { _name_ as default };
//# sourceMappingURL=_name_-17q8k8b-.mjs.map
