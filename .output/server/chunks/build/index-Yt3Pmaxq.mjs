...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-root" }, _attrs))} data-v-8a9ad90c>`);
      ...
      _push(`<div class="container" data-v-8a9ad90c><div class="path-links text-start pt-4" data-v-8a9ad90c><h5 class="links-frame" dir="auto" data-v-8a9ad90c>`);
      ...
      _push(` / <span class="path-link" data-v-8a9ad90c>${ssrInterpolate(_ctx.$t("About Us"))}</span></h5></div></div><div class="page-body container"${ssrRenderAttr("dir", ("rtl" in _ctx ? _ctx.rtl : unref(rtl))())} data-v-8a9ad90c><div class="main-content" data-v-8a9ad90c><div class="content-body" data-v-8a9ad90c><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "mb-10 px-0"])}" dir="auto" data-v-8a9ad90c><h1 class="metal-text" data-v-8a9ad90c><span data-v-8a9ad90c>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(dataResult)))}</span></h1></div><div class="description" data-v-8a9ad90c><div class="section" data-v-8a9ad90c><div class="des" data-v-8a9ad90c>${(_a2 = ("useDes" in _ctx ? _ctx.useDes : unref(useDes))(unref(dataResult))) != null ? _a2 : ""}</div></div><div class="section" data-v-8a9ad90c>`);
      if ((_a = unref(dataResult)) == null ? void 0 : _a.image1) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-8a9ad90c><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).image1))} alt=" Photo" data-v-8a9ad90c></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-8a9ad90c>${(_b2 = ("useDes1" in _ctx ? _ctx.useDes1 : unref(useDes1))(unref(dataResult))) != null ? _b2 : ""}</div></div><div class="section" data-v-8a9ad90c>`);
      if ((_b = unref(dataResult)) == null ? void 0 : _b.image2) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-8a9ad90c><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).image2))} alt=" Photo" data-v-8a9ad90c></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-8a9ad90c>${(_c2 = ("useDes2" in _ctx ? _ctx.useDes2 : unref(useDes2))(unref(dataResult))) != null ? _c2 : ""}</div></div><div class="section" data-v-8a9ad90c>`);
      if ((_c = unref(dataResult)) == null ? void 0 : _c.image3) {
        _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-8a9ad90c><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).image3))} alt=" Photo" data-v-8a9ad90c></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="des" data-v-8a9ad90c>${(_d = ("useDes3" in _ctx ? _ctx.useDes3 : unref(useDes3))(unref(dataResult))) != null ? _d : ""}</div></div></div></div></div></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8a9ad90c"]]);

export { index as default };
//# sourceMappingURL=index-Yt3Pmaxq.mjs.map
