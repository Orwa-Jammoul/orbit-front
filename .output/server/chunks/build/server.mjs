import { hasInjectionContext, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, inject, defineAsyncComponent, computed, unref, shallowReactive, ref, Suspense, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext, Text } from 'vue';
import { m as sanitizeStatusCode, n as getContext, $ as $fetch, o as createHooks, p as executeAsync, f as createError$1, q as toRouteMatcher, r as createRouter$1, v as defu, w as getRequestProtocol, d as destr, x as klona, y as getRequestHeaders, z as parse$1, A as getRequestHeader, B as isEqual$1, C as setCookie, D as getCookie, E as deleteCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-CHSWrYY5.mjs')
  },
  {
    name: "index___ar",
    path: "/ar",
...
const namedMiddleware = {
  "auth-product-exists": () => import('./auth-product-exists-rUkdl5_w.mjs'),
  auth: () => import('./auth-CSNwk8_W.mjs'),
  "not-authorize": () => import('./not-authorize-DrdUKWXm.mjs'),
  "supplier-company": () => import('./supplierCompany-CAsK8BdV.mjs'),
  "validate-id-digital": () => import('./validate-id-digital-eF0_7j8I.mjs')
};
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Cz-LWqQD.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BeMzR5oU.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-0blXm9w9.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, withoutTrailingSlash as c, nuxtLinkDefaults as d, entry$1 as default, defineNuxtRouteMiddleware as e, hasProtocol as h, joinURL as j, navigateTo as n, parseQuery as p, resolveRouteObject$1 as r, tryUseNuxtApp as t, useRouter as u, withTrailingSlash as w };
