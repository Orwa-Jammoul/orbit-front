...
import { _ as __nuxt_component_1 } from './course-BsFteZ8g.mjs';
...
import { u as useRuntimeConfig, e as useI18n, a as useLocalePath, b as useGetSiteApi, d as useHead, f as useRoute$1 } from './server.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(` / <span class="path-link">${ssrInterpolate(_ctx.$t("training"))}</span></h5></div><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "mb-10 px-0"])}" dir="auto"><h1 class="metal-text"><span>${ssrInterpolate(_ctx.$t("training"))}</span></h1></div></div><div class="container"${ssrRenderAttr("dir", ("rtl" in _ctx ? _ctx.rtl : unref(rtl))())}><div class="row"><!--[-->`);
...
//# sourceMappingURL=index-UGQLhVlw.mjs.map
