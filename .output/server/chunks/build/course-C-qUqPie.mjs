...
import { d as useEndpoint, r as rtl, c as cImg, u as useName, j as useTr } from './useMethods-DGpMLSZI.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_nuxt_link, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="gr-circle1" data-v-a3e63e55${_scopeId}></div><div class="service-card-frame" data-v-a3e63e55${_scopeId}><div class="card-top" data-v-a3e63e55${_scopeId}><div class="img-frame cover" data-v-a3e63e55${_scopeId}><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(__props.cardData.courseImageUrl1))}${ssrRenderAttr("alt", ("useName" in _ctx ? _ctx.useName : unref(useName))(__props.cardData))} data-v-a3e63e55${_scopeId}></div></div><div class="card-bottom" data-v-a3e63e55${_scopeId}><h5 class="card-title" data-v-a3e63e55${_scopeId}>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(__props.cardData))}</h5><p class="card-cat" data-v-a3e63e55${_scopeId}>${ssrInterpolate(("useTr" in _ctx ? _ctx.useTr : unref(useTr))(__props.cardData.courseParentCategoryNameEn, __props.cardData.courseParentCategoryNameAr, __props.cardData.courseParentCategoryNameGe))}</p></div><div class="buttons pcc" data-v-a3e63e55${_scopeId}><button class="details-btn" data-v-a3e63e55${_scopeId}>${ssrInterpolate(_ctx.$t("details"))}</button></div></div>`);
          } else {
            return [
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a3e63e55"]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=course-C-qUqPie.mjs.map
