...
import { f as useEndpoint, r as rtl, c as cImg, u as useName } from './useMethods-36IGheXp.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_nuxt_link, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="gr-circle1" data-v-f3e29c2a${_scopeId}></div><div class="service-card-frame" data-v-f3e29c2a${_scopeId}><div class="card-top" data-v-f3e29c2a${_scopeId}><div class="img-frame cover" data-v-f3e29c2a${_scopeId}><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(__props.cardData.productImageUrl1))}${ssrRenderAttr("alt", ("useName" in _ctx ? _ctx.useName : unref(useName))(__props.cardData))} data-v-f3e29c2a${_scopeId}></div></div><div class="card-bottom" data-v-f3e29c2a${_scopeId}><h5 class="card-title" data-v-f3e29c2a${_scopeId}>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(__props.cardData))}</h5><p class="card-cat" data-v-f3e29c2a${_scopeId}>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(__props.cardData.productDefaultCategory))}</p></div><div class="buttons pcc" data-v-f3e29c2a${_scopeId}><button class="details-btn" data-v-f3e29c2a${_scopeId}>${ssrInterpolate(_ctx.$t("details"))}</button></div></div>`);
          } else {
            return [
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f3e29c2a"]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=service-C3K_aPJI.mjs.map
