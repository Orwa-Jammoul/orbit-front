...
import { _ as __nuxt_component_1 } from './service-CLxn2mXN.mjs';
...
import { a as useLocalePath, u as useRuntimeConfig, e as useI18n, b as useGetSiteApi, d as useHead, f as useRoute$1 } from './server.mjs';
import '../_/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="container" dir="auto"><div class="row path-links text-start pt-4"><h5 class="links-frame" dir="auto">`);
      ...
      _push(` / <span class="path-link">${ssrInterpolate(_ctx.$t("services"))}</span></h5></div><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "mb-10 px-0"])}" dir="auto"><h1 class="metal-text"><span>${ssrInterpolate(_ctx.$t("services"))}</span></h1></div></div><div class="container"${ssrRenderAttr("dir", ("rtl" in _ctx ? _ctx.rtl : unref(rtl))())}><div class="row"><!--[-->`);
...
//# sourceMappingURL=index-D6nw87Ye.mjs.map
