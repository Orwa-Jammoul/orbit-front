...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-11e1be63><div class="gr-circle1" data-v-11e1be63></div><div class="gr-circle3" data-v-11e1be63></div><div class="service-card-frame" data-v-11e1be63><div class="card-top pcc" data-v-11e1be63><div class="icon-frame pcc" data-v-11e1be63>`);
      ...
      _push(`</div></div><div class="card-bottom" data-v-11e1be63><div class="card-title-frame pcc" data-v-11e1be63><h5 class="card-title" data-v-11e1be63>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(__props.cardData))}</h5></div><div class="card-des-frame pcc" data-v-11e1be63><div class="card-des" data-v-11e1be63>${(_a = ("useDes" in _ctx ? _ctx.useDes : unref(useDes))(__props.cardData)) != null ? _a : ""}</div></div></div></div></div>`);
    };
  }
};
...
const CardWorkStep = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-11e1be63"]]);
const _sfc_main$4 = {
  __name: "HowDoWeWork",
  __ssrInlineRender: true,
  async setup(__props) {
...
//# sourceMappingURL=index-CUIpGIWt.mjs.map
