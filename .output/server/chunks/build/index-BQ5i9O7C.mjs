...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "design-root" }, _attrs))} data-v-73db5f0b><div class="bg-section" data-v-73db5f0b>`);
      if (!unref(videosLoaded)) {
        _push(`<div class="loading-placeholder" data-v-73db5f0b></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ssrRenderList(videoSources, (video, index) => {
        _push(`<video class="bg-video" style="${ssrRenderStyle({ display: unref(currentVideoIndex) === index ? "block" : "none" })}" muted playsinline preload="auto" data-v-73db5f0b><source${ssrRenderAttr("src", video.src)}${ssrRenderAttr("type", video.type)} data-v-73db5f0b> Your browser does not support the video tag. </video>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-73db5f0b"]]);
const _sfc_main$6 = {
  __name: "MainHeader",
  __ssrInlineRender: true,
  async setup(__props) {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({
        ...
        dir: "auto"
      }, _attrs))} data-v-e21a200e><div class="img-frame contain" data-v-e21a200e><img${ssrRenderAttr("src", _imports_0)} alt="image" data-v-e21a200e></div><div class="about-frame" data-v-e21a200e><div class="about-box1 grid-bg1" data-v-e21a200e><h1 class="metal-text" data-v-e21a200e>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(about)))}</h1><p data-v-e21a200e>${ssrInterpolate(("getInnerText" in _ctx ? _ctx.getInnerText : unref(getInnerText))(("useDes" in _ctx ? _ctx.useDes : unref(useDes))(unref(about))))}</p><div class="go-to pcs" data-v-e21a200e><p class="m-0" data-v-e21a200e>${ssrInterpolate(_ctx.$t("read-more"))}</p>`);
      ...
      _push(`</div><div class="gr-circle1" data-v-e21a200e></div><div class="gr-circle3" data-v-e21a200e></div></div><div class="about-box2 grid-bg1" data-v-e21a200e><h1 class="metal-text" data-v-e21a200e>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(about)))}</h1><p data-v-e21a200e>${ssrInterpolate(("getInnerText" in _ctx ? _ctx.getInnerText : unref(getInnerText))(("useDes" in _ctx ? _ctx.useDes : unref(useDes))(unref(about))))}</p><div class="go-to pcs" data-v-e21a200e><p class="m-0" data-v-e21a200e>${ssrInterpolate(_ctx.$t("read-more"))}</p>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        class: "icon-frame pcc mx-0 ms-2",
        to: ("localePath" in _ctx ? _ctx.localePath : unref(localePath))("/about-us")
      }, {
      ...
      _push(`</div><div class="gr-circle1" data-v-e21a200e></div><div class="gr-circle3" data-v-e21a200e></div></div></div><div class="gr-circle1" data-v-e21a200e></div><div class="gr-circle2" data-v-e21a200e></div></section>`);
    };
  }
};
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-e21a200e"]]);
const _sfc_main$4 = {
  __name: "Services",
  __ssrInlineRender: true,
  async setup(__props) {
...
//# sourceMappingURL=index-BQ5i9O7C.mjs.map
