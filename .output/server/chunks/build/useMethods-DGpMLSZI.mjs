import { g as useI18n, u as useRuntimeConfig, j as useLang } from './server.mjs';

const vNotFound = "";
const dNotFound = "";
const defaultLang = "en";
const useTr = (english, arabic, germany) => {
  var _a;
...
const useEndpoint = (data) => {
  ...
  let value;
  if (lang === "en") {
    value = (_a = data.endpointEn) != null ? _a : vNotFound;
  } else if (lang === "de") {
    value = (_b = data.endpointGe) != null ? _b : vNotFound;
  } else {
    value = (_c = data.endpointAr) != null ? _c : vNotFound;
  }
  return value;
};
const useAlt = (data, num = 1) => {
  if (!data) {
    return dNotFound;
  }
  const { locale } = useI18n();
...
export { useDes as a, useDes1 as b, cImg as c, useEndpoint as d, useDes2 as e, useDes3 as f, getInnerText as g, useAlt as h, isAr as i, useTr as j, useIcon as k, rtl as r, useName as u };
//# sourceMappingURL=useMethods-DGpMLSZI.mjs.map
