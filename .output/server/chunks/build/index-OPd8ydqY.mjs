  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({
        ...
        dir: "auto"
      }, _attrs))} data-v-df595138><div class="img-frame contain" data-v-df595138><img${ssrRenderAttr("src", _imports_0)} alt="image about us" data-v-df595138></div><div class="about-frame" data-v-df595138><div class="about-box1 grid-bg1" data-v-df595138><h1 class="metal-text" data-v-df595138>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(about)))}</h1><p data-v-df595138>${ssrInterpolate(("getInnerText" in _ctx ? _ctx.getInnerText : unref(getInnerText))(("useDes" in _ctx ? _ctx.useDes : unref(useDes))(unref(about))))}</p><div class="go-to pcs" data-v-df595138><p class="m-0" data-v-df595138>${ssrInterpolate(_ctx.$t("read-more"))}</p>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
      ...
      _push(`</div><div class="gr-circle1" data-v-df595138></div><div class="gr-circle3" data-v-df595138></div></div><div class="about-box2 grid-bg1" data-v-df595138><p data-v-df595138>${ssrInterpolate(("getInnerText" in _ctx ? _ctx.getInnerText : unref(getInnerText))(("useDes1" in _ctx ? _ctx.useDes1 : unref(useDes1))(unref(about))))}</p><div class="go-to pcs" data-v-df595138><p class="m-0" data-v-df595138>${ssrInterpolate(_ctx.$t("read-more"))}</p>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        class: "icon-frame pcc mx-0 ms-2",
        to: unref(localePath)("about-us")
      }, {
      ...
      _push(`</div><div class="gr-circle1" data-v-df595138></div><div class="gr-circle3" data-v-df595138></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-df595138"]]);
const _sfc_main$1 = {};
...
//# sourceMappingURL=index-OPd8ydqY.mjs.map
