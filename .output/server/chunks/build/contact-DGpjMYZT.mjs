import __nuxt_component_0$1 from './index-lD4fRCLv.mjs';
...
import { _ as _export_sfc, y as useMenu, g as useI18n, u as useRuntimeConfig, w as configure, x as Form, t as useMainToken, l as useNuxtApp, F as Field, E as ErrorMessage, v as useFetch, r as navigateTo } from './server.mjs';
import * as yup from 'yup';
import { r as rtl, i as isAr, k as useIcon } from './useMethods-DGpMLSZI.mjs';
...
const useHttpForSiteApi = () => {
  ...
  const getRequestConfig = (method, endpoint, data, isServer, isLazy) => ({
    ...
    baseURL: apiBase,
    method,
    body: method !== "delete" ? data : void 0,
    server: isServer,
    lazy: isLazy,
    headers: {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Form), mergeProps({
        ...
        default: withCtx(({ meta: formMeta }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="form-types" data-v-48f8b5a7${_scopeId}><div class="${ssrRenderClass([{ "active": unref(selectedType) == 0 }, "form-type-item pcc"])}" data-v-48f8b5a7${_scopeId}>${ssrInterpolate(_ctx.$t("Suggestion"))}</div><div class="${ssrRenderClass([{ "active": unref(selectedType) == 1 }, "form-type-item pcc"])}" data-v-48f8b5a7${_scopeId}>${ssrInterpolate(_ctx.$t("Complaint"))}</div><div class="${ssrRenderClass([{ "active": unref(selectedType) == 2 }, "form-type-item pcc"])}" data-v-48f8b5a7${_scopeId}>${ssrInterpolate(_ctx.$t("Inquiry"))}</div><div class="${ssrRenderClass([{ "active": unref(selectedType) == 3 }, "form-type-item pcc"])}" data-v-48f8b5a7${_scopeId}>${ssrInterpolate(_ctx.$t("Appointment"))}</div></div><div class="form-fields" data-v-48f8b5a7${_scopeId}>`);
            ...
            _push2(`</div><div class="pcc my-2" data-v-48f8b5a7${_scopeId}><button type="submit" value="Login" class="${ssrRenderClass([{ "btn-success": formMeta.valid }, "btn-main btn-block mx-2"])}"${ssrIncludeBooleanAttr(!formMeta.valid || unref(isLoading)) ? " disabled" : ""} data-v-48f8b5a7${_scopeId}>`);
            if (!unref(isLoading)) {
              _push2(`<span data-v-48f8b5a7${_scopeId}>${ssrInterpolate(_ctx.$t("send"))}</span>`);
            } else {
              _push2(`<span data-v-48f8b5a7${_scopeId}>${ssrInterpolate(_ctx.$t("loading..."))}</span>`);
            }
            _push2(`</button><div class="btn-main btn-block mx-2" data-v-48f8b5a7${_scopeId}><span data-v-48f8b5a7${_scopeId}>${ssrInterpolate(_ctx.$t("cancel"))}</span></div></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "pcc my-2" }, [
                createVNode("button", {
                  type: "submit",
                  value: "Login",
                  class: ["btn-main btn-block mx-2", { "btn-success": formMeta.valid }],
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-48f8b5a7"]]);
const _sfc_main = {
  __name: "contact",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=contact-DGpjMYZT.mjs.map
