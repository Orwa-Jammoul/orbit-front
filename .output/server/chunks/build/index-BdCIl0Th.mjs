import { _ as __nuxt_component_0, l as localePath, r as rtl } from './useMethods-Bj3Kkejg.mjs';
import { _ as __nuxt_component_1 } from './service-BZCA6mwA.mjs';
import __nuxt_component_2 from './Icon-CBg3hLjd.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(` / <span class="path-link">${ssrInterpolate(_ctx.$t("services"))}</span></h5></div><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "mb-10 px-0"])}" dir="auto"><h1 class="metal-text"><span>${ssrInterpolate(_ctx.$t("services"))}</span></h1></div></div><div class="container">`);
      if (!unref(isLoading)) {
        _push(`<div class="row"><!--[-->`);
...
//# sourceMappingURL=index-BdCIl0Th.mjs.map
