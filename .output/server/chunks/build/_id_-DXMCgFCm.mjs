...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(isLoading)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-root" }, _attrs))} data-v-deccec9f><div class="container" data-v-deccec9f><div class="path-links text-start pt-4" data-v-deccec9f><h5 class="links-frame" dir="auto" data-v-deccec9f>`);
        ...
        _push(` / <span class="path-link" data-v-deccec9f>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(dataResult)))}</span></h5></div></div><div class="page-body container"${ssrRenderAttr("dir", ("rtl" in _ctx ? _ctx.rtl : unref(rtl))())} data-v-deccec9f><div class="main-content" data-v-deccec9f><div class="content-body" data-v-deccec9f><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "mb-10 px-0"])}" dir="auto" data-v-deccec9f><h1 class="metal-text" data-v-deccec9f><span data-v-deccec9f>${ssrInterpolate(("useName" in _ctx ? _ctx.useName : unref(useName))(unref(dataResult)))}</span></h1></div><div class="description" data-v-deccec9f><div class="section" data-v-deccec9f>`);
        if ((_a = unref(dataResult)) == null ? void 0 : _a.image) {
          _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-deccec9f><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).image))} alt=" Photo" data-v-deccec9f></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="des" data-v-deccec9f>${(_a2 = ("useDes" in _ctx ? _ctx.useDes : unref(useDes))(unref(dataResult))) != null ? _a2 : ""}</div></div><div class="section" data-v-deccec9f>`);
        if ((_b = unref(dataResult)) == null ? void 0 : _b.image1) {
          _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-deccec9f><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).image1))} alt=" Photo" data-v-deccec9f></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="des" data-v-deccec9f>${(_b2 = ("useDes1" in _ctx ? _ctx.useDes1 : unref(useDes1))(unref(dataResult))) != null ? _b2 : ""}</div></div><div class="section" data-v-deccec9f>`);
        if ((_c = unref(dataResult)) == null ? void 0 : _c.image2) {
          _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-deccec9f><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).image2))} alt=" Photo" data-v-deccec9f></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="des" data-v-deccec9f>${(_c2 = ("useDes2" in _ctx ? _ctx.useDes2 : unref(useDes2))(unref(dataResult))) != null ? _c2 : ""}</div></div><div class="section" data-v-deccec9f>`);
        if ((_d = unref(dataResult)) == null ? void 0 : _d.image3) {
          _push(`<div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "img-frame contain"])}" data-v-deccec9f><img${ssrRenderAttr("src", ("cImg" in _ctx ? _ctx.cImg : unref(cImg))(unref(dataResult).image3))} alt=" Photo" data-v-deccec9f></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="des" data-v-deccec9f>${(_d2 = ("useDes3" in _ctx ? _ctx.useDes3 : unref(useDes3))(unref(dataResult))) != null ? _d2 : ""}</div></div></div></div><aside class="side-nav" data-v-deccec9f><p class="px-0 ps-2" data-v-deccec9f>${ssrInterpolate(_ctx.$t("more"))}</p><!--[-->`);
        ssrRenderList(unref(similarItems), (similar, index) => {
          _push(`<div class="mb-3" data-v-deccec9f>`);
          _push(ssrRenderComponent(_component_CardServiceH, { cardData: similar }, null, _parent));
          _push(`</div>`);
        });
        _push(`<!--]--></aside></div></div><div class="container" data-v-deccec9f>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-deccec9f"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-DXMCgFCm.mjs.map
