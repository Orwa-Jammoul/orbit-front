...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))}><div class="${ssrRenderClass([("rtl" in _ctx ? _ctx.rtl : unref(rtl))(), "row section-title"])}"><h2 class="metal-text mb-5">${ssrInterpolate(_ctx.$t("training"))}</h2></div>`);
...
//# sourceMappingURL=training-CERSr_Iz.mjs.map
